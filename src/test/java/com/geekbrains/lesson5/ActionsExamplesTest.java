...
public class ActionsExamplesTest {
    ...
    void afishaTest () {
        ...
        webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[.='Куда сходить " +
                "с ребенком в Москве']")));
    }
    ...
    void iframeTest () throws InterruptedException {
        ...
        customWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//iframe[contains(@id, " +
                "'crm_project_planning')]")));
